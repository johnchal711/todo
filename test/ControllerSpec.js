...
describe('controller', function () {
	...
	describe('routing', function () {
		...
		it('should show active entries', function () {
			// TODO: write test
	    	 // thasks that are completed  must be set to false (completed = false).
			...
			subject.setView('#/active');
			  ...
			  // Expect fetch only active todos
		...
		it('should show completed entries', function () {
			// TODO: write test
 			//  thasks that are completed  must be set  to true (completed = true).);

			var todo = {title: 'my todo', completed:true};
			setUpModel([todo]);

			subject.setView('#/completed');
			// Expect fetch only completed todos
	...
	describe('new todo', function () {
		it('should add a new todo to the model', function () {
			...
			//Set up model with an empty array (no todos are required for this test) and init the default view
			setUpModel([]);
			...
			expect(model.create).toHaveBeenCalledWith("A new to do item",jasmine.any(Function));
			//  **************** END EDIT ******************
		});
